...
*   **Subtask 1.1**: Initialize Context Manifest (`cli.py manifest`).
*   **Subtask 1.2**: Generate context bundle (`cli.py bundle`).
...
- **Rule Updates**: If a standard was ambiguous, update the `.agent/rules/`.
...
- **Final Artifacts**: Provide direct links to all new or modified documentation (e.g., `[Overview Page](.agent/docs/modernization/overview.md)`).
