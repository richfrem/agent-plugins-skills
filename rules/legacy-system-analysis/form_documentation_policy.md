...
**Rule File:** [std_context_first_analysis.md](.agent/rules/legacy-system-analysis/standards/std_context_first_analysis.md)
> [!CRITICAL]
...
*   **Task Creation**: Create a task file (e.g., `tasks/todo/NNNN-analyze-target.md`) defining the scope and subtasks. See [task_creation.md](.agent/rules/legacy-system-analysis/task_creation.md).
...
**Primary Tool:** `cli.py context --target [ID] --type form`
...
Run `cli.py bundle --target [ID]` and check the RLM Summary. Does it already describe this rule?
...
**Rule File:** [std_technical_implementation.md](.agent/rules/legacy-system-analysis/standards/std_technical_implementation.md)
*   Link Source Artifacts (FMB/XML).
*   List Attached Libraries.

### E. Application Menus (App Overviews Only)
**Rule File:** [std_application_menus.md](.agent/rules/legacy-system-analysis/standards/std_application_menus.md)

### F. Smart Linking
**Rule File:** [std_smart_linking.md](.agent/rules/legacy-system-analysis/standards/std_smart_linking.md)
*   Use `enrich_links_v2.py` to enforce syntax.

### H. QA & Template Completion
**Rule File:** [std_qa_template_completion.md](.agent/rules/legacy-system-analysis/standards/std_qa_template_completion.md)
...
|------|-------------|-------|
| `cli.py bundle` | Windows or WSL | Primary discovery tool |
...
- [ ] **Context gathered** - `cli.py bundle --target [ID]` was run
