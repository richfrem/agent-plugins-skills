...
See [std_business_rules.md](.agent/rules/legacy-system-analysis/standards/std_business_rules.md) or Form Policy for CLI commands.

### Step 4: Document Findings
Create or update workflow documentation using the [Workflow Template](.agent/.agent/templates/meta/workflow-definition-template.md).
...
*   New patterns discovered should be added to the [Template](.agent/.agent/templates/meta/workflow-definition-template.md).
