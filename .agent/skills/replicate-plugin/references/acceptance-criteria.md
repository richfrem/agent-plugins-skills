...
The replicate-plugin skill must meet the following criteria to be considered operational:
...
- [ ] After a successful replication, the agent reminds the user to run `maintain-plugins sync` in the target project to activate the plugins in agent environments.
