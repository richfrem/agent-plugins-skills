...
2. Must not assume the existence of external `spec-kitty` branch dependencies or global templates.
3. Must generate `handoffs/` and `retros/` dynamically in the active Project Runtime, not hardcoded into `.agent/handoffs/`.
