...
**Applies to**: `concurrent-agent-loop/SKILL.md`, new `references/orchestrator-meta-survey.md` template, `init_flywheel_files.py` (seed backlog.md)
...
**Applies to**: `skill-improvement-eval/scripts/eval_runner.py`
...
**Applies to**: `eval_runner.py` (Option D), `concurrent-agent-loop/SKILL.md` (Options A/C)
...
**Applies to**: `eval_runner.py`, `concurrent-agent-loop/SKILL.md` Standard Cycle step 4, `skill-improvement-eval/SKILL.md`
...
**Applies to**: `concurrent-agent-loop/SKILL.md` step 6.5, step 1 Orientation (check for `task_promotion_needed` events)
