...
LOCAL_ROOT = Path(".")
# Bridge installer is now localized within plugin-manager
PROJECT_ROOT = SCRIPT_DIR.parents[2]  # scripts→maintain-plugins→skills→plugin-manager
BRIDGE_INSTALLER = PROJECT_ROOT / "scripts/bridge_installer.py"
