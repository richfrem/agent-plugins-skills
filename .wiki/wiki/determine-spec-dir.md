---
concept: determine-spec-dir
source: plugin-code
source_file: spec-kitty-plugin/scripts/verify_workflow_state.py
wiki_root: /Users/richardfremmerlid/Projects/agent-plugins-skills/.wiki
generated_at: 2026-04-27T05:21:04.412670+00:00
cluster: spec_dir
content_hash: 2236b25c79b14130
---
...
def main() -> None:
    ...
    print(f"\n✅ Phase '{args.phase}' verification passed for {spec_dir.nam
...
- [[support-both-layouts-eval-dirs-directly-under-benchmark-dir-or-under-runs]]

## Raw Source

- **Source:** `plugin-code`
- **File:** `spec-kitty-plugin/scripts/verify_workflow_state.py`
- **Indexed:** 2026-04-27T05:21:04.412670+00:00
