---
concept: plugin-synchronization-cleanup-process
source: plugin-code
source_file: spec-kitty-plugin/.agents/skills/maintain-plugins/references/cleanup_process.md
wiki_root: /Users/richardfremmerlid/Projects/agent-plugins-skills/.wiki
generated_at: 2026-04-17T06:42:10.111617+00:00
cluster: vendor
content_hash: 92584aa1c5de9942
---
...
This document explains the logic used by `../scripts/sync_with_inventory.py` to manage plugin lifecycles in consuming repositories. It is invoked via the **[maintain-plugins](../skills/maintain-plugins/SKILL.md)** skill (Sync operation). The goal is to keep vendor plugins up-to-date while protecting project-specific customizations.


![Process Diagram](../assets/diagrams/cleanup_flow.mmd)
...
- **Source:** `plugin-code`
- **File:** `spec-kitty-plugin/.agents/skills/maintain-plugins/references/cleanup_process.md`
- **Indexed:** 2026-04-17T06:42:10.111617+00:00
