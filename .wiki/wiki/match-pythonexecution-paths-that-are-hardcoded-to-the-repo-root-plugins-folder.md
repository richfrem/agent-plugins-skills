---
concept: match-pythonexecution-paths-that-are-hardcoded-to-the-repo-root-plugins-folder
source: plugin-code
source_file: agent-scaffolders/scripts/auto_fix_local_links.py
wiki_root: /Users/richardfremmerlid/Projects/agent-plugins-skills/.wiki
generated_at: 2026-04-27T05:21:03.819259+00:00
cluster: plugin-code
content_hash: 2b60970538587351
---
    ...
    for line in lines:
        ...
        def replacer(match: re.Match) -> str:
            ...
            if not target.startswith("scripts/"):
                # if the original string was plugins/agent-scaffolders/scripts/foo.py
...
- **Source:** `plugin-code`
- **File:** `agent-scaffolders/scripts/auto_fix_local_links.py`
- **Indexed:** 2026-04-27T05:21:03.819259+00:00
