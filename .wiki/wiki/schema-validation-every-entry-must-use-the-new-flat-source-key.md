---
concept: schema-validation-every-entry-must-use-the-new-flat-source-key
source: plugin-code
source_file: plugin-manager/scripts/test_plugin_lifecycle.py
wiki_root: /Users/richardfremmerlid/Projects/agent-plugins-skills/.wiki
generated_at: 2026-04-27T05:21:04.030713+00:00
cluster: print
content_hash: 1b9c2bc33661a51c
---
...
def main() -> None:
    ...
    run_command([python_exec, add_script, githu
...
- **Source:** `plugin-code`
- **File:** `plugin-manager/scripts/test_plugin_lifecycle.py`
- **Indexed:** 2026-04-27T05:21:04.030713+00:00
