---
concept: procedural-fallback-tree-excel-conversion
source: plugin-code
source_file: spec-kitty-plugin/.agents/skills/excel-to-csv/references/fallback-tree.md
wiki_root: /Users/richardfremmerlid/Projects/agent-plugins-skills/.wiki
generated_at: 2026-04-17T06:42:10.076382+00:00
cluster: user
content_hash: c6f05d4e713925ad
---
...
If the primary Conversion Engine (`./../scripts/convert.py`) fails, execute the following triage steps exactly in order:

## 1. Engine Execution Failure (ImportError / Env Issues)
If `./../scripts/convert.py` crashes due to missing dependencies (`pandas` or `openpyxl`):
...
If `./../scripts/verify_csv.py` returns `EmptyFile` or the conversion summary says `Skipped (empty)`:
...
If `./../scripts/verify_csv.py` returns `JaggedRow`:
...
- **Source:** `plugin-code`
- **File:** `spec-kitty-plugin/.agents/skills/excel-to-csv/references/fallback-tree.md`
- **Indexed:** 2026-04-17T06:42:10.076382+00:00
