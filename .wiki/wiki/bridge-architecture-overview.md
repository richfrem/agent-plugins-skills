---
concept: bridge-architecture-overview
source: plugin-code
source_file: spec-kitty-plugin/references/bridge_architecture_overview.md
wiki_root: /Users/richardfremmerlid/Projects/agent-plugins-skills/.wiki
generated_at: 2026-04-17T06:42:10.372284+00:00
cluster: agent
content_hash: e46658fe37516cfc
---
...
### B. Plugin Bridge Installer (`plugin-installer` skill in `plugin-manager`)
...
-   **Usage (Plugins)**: Trigger the `plugin-installer` skill (in `plugin-manager`) to install a specific plugin into agent environments.
...
- **Source:** `plugin-code`
- **File:** `spec-kitty-plugin/references/bridge_architecture_overview.md`
- **Indexed:** 2026-04-17T06:42:10.372284+00:00
