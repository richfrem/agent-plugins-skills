...
## Context
This repository houses an extensive ecosystem of agent plugins and skills, ranging from pure functional utilities (`context-bundler`, `mermaid-to-png`) to complex orchestration frameworks (`spec-kitty-plugin`, `agent-agentic-os`, `agent-orchestration/stration/stration/stration/stration/stration/stration/stration/`).
...
2. **Pluggable Execution**: Sub-system plugins must operate in total isolation. For example, `agent-orchestration/stration/stration/stration/stration/stration/stration/stration/` must not require an awareneagent-orchestration/ent-orchestration/ent-orchestration/ent-orchestration/ent-orchestration/ent-orchestration/ent-orchestration/ent-orchestration/`, the plugin must work flawlessly on its own.
...
- **Portability**: End-users can install `agent-orchestration/stration/stration/stration/stration/stration/stration/stration/` or `rlm-factory` in isolation without being forced to adopt our entire monolithic workflow stack.
