...
```bash
python3 ~~agent-scaffolders-root/skills/create-docker-skill/scripts/scaffold.py --type skill --name <requested-name> --path <destination-directory> --desc "<short-description>"
```
