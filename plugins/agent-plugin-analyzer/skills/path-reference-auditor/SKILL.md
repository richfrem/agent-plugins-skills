...
python3 ./check_skill_boundaries.py temp/inventory.json --skill adr-management
```
...
python3 ./check_plugin_boundaries.py temp/inventory.json --plugin bridge-plugin
```
...
python3 ./check_skill_boundaries.py temp/inventory.json --skill my-skill

# Test one plugin after changes
python3 ./check_plugin_boundaries.py temp/inventory.json --plugin my-plugin
```
