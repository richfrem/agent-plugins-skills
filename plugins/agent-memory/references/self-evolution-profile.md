# Self-Evolution Profile — Agent Memory

## Allowed Edit Directories

- plugins/agent-memory/skills/
- plugins/agent-memory/scripts/
- plugins/agent-memory/references/
...
`plugins/agent-memory/references/evolution-log.md`
