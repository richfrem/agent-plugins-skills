...
Key Input Dependencies:
    - path_security.py module (in the same directory, for containment checks)
    - context/exploration/.secrets/ directory (for HMAC key rotation)
"""
...
def verify_sandbox():
    """Check environment hygiene (banned vars) and path containment enforcement."""
...
def rotate_key():
    """Generate a new 32-byte HMAC session key and write it with 0600 permissions."""
...
def main():
    """Parse CLI subcommand and dispatch to verify-sandbox or rotate-key."""
