...
ALLOWED_TRANSITIONS = {
    "INTAKE": ["INTERVIEW", "PLAN_REVIEW", "ESCALATED"],
    "INTERVIEW": ["PLAN_REVIEW", "ESCALATED"],
    "PLAN_REVIEW": ["AWAITING_APPROVAL", "INTERVIEW", "ESCALATED"],
    "AWAITING_APPROVAL": ["APPROVED", "PLAN_REVIEW", "ESCALATED"],
