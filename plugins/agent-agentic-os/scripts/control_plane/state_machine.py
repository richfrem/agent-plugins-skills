...
ALLOWED_TRANSITIONS = {
    ...
    "INTERVIEW": ["DRAFT_PLAN", "PLAN_REVIEW", "RETROSPECTIVE", "ESCALATED", "INTAKE"],
    "DRAFT_PLAN": ["PLAN_REVIEW", "INTERVIEW", "ESCALATED", "INTAKE"],
    "MULTI_AGENT_REVIEW": ["DRAFT_PLAN", "PLAN_REVIEW", "ESCALATED", "INTAKE"],
    "PLAN_REVIEW": ["MULTI_AGENT_REVIEW", "AWAITING_APPROVAL", "DRAFT_PLAN", "INTERVIEW", "ESCALATED", "INTAKE"],
    "AWAITING_APPROVAL": ["APPROVED", "PLAN_REVIEW", "DRAFT_PLAN", "ESCALATED", "INTAKE"],
    "APPROVED": ["IN_WORKTREE", "ESCALATED", "INTAKE"],
