...
ALLOWED_TRANSITIONS = {
    ...
    "INTERVIEW": ["DRAFT_PLAN", "PLAN_REVIEW", "RETROSPECTIVE", "DONE", "ESCALATED", "INTAKE"],
    "DRAFT_PLAN": ["PLAN_REVIEW", "INTERVIEW", "DONE", "ESCALATED", "INTAKE"],
    "MULTI_AGENT_REVIEW": ["DRAFT_PLAN", "PLAN_REVIEW", "DONE", "ESCALATED", "INTAKE"],
    "PLAN_REVIEW": ["MULTI_AGENT_REVIEW", "AWAITING_APPROVAL", "DRAFT_PLAN", "INTERVIEW", "DONE", "ESCALATED", "INTAKE"],
    "AWAITING_APPROVAL": ["APPROVED", "PLAN_REVIEW", "DRAFT_PLAN", "DONE", "ESCALATED", "INTAKE"],
    "APPROVED": ["IN_WORKTREE", "RETROSPECTIVE", "DONE", "ESCALATED", "INTAKE"],
    "IN_WORKTREE": ["WORKTREE_REVIEW", "VERIFY_EXIT", "ROLLED_BACK", "DONE", "ESCALATED", "INTAKE"],
    "WORKTREE_REVIEW": ["MULTI_AGENT_CODE_REVIEW", "VERIFY_EXIT", "IN_WORKTREE", "ROLLED_BACK", "DONE", "ESCALATED", "INTAKE"],
    "MULTI_AGENT_CODE_REVIEW": ["WORKTREE_REVIEW", "VERIFY_EXIT", "IN_WORKTREE", "ROLLED_BACK", "DONE", "ESCALATED", "INTAKE"],
    "VERIFY_EXIT": ["RETROSPECTIVE", "IN_WORKTREE", "WORKTREE_REVIEW", "ROLLED_BACK", "DONE", "ESCALATED", "INTAKE"],
    "RETROSPECTIVE": ["DONE", "ESCALATED", "INTAKE"],
    "DONE": ["INTAKE"],
    "ROLLED_BACK": ["DONE", "ESCALATED", "PLAN_REVIEW", "INTAKE"],
    "ESCALATED": ["DONE", "INTAKE", "PLAN_REVIEW"]
}
