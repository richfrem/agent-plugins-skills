...
ALLOWED_TRANSITIONS = {
    "INTAKE": ["INTERVIEW", "DRAFT_PLAN", "PLAN_REVIEW", "ESCALATED", "DONE", "RETROSPECTIVE"],
    "INTERVIEW": ["DRAFT_PLAN", "PLAN_REVIEW", "RETROSPECTIVE", "ESCALATED", "INTAKE", "DONE"],
    "DRAFT_PLAN": ["PLAN_REVIEW", "INTERVIEW", "ESCALATED", "INTAKE", "DONE", "RETROSPECTIVE"],
    "MULTI_AGENT_REVIEW": ["DRAFT_PLAN", "PLAN_REVIEW", "ESCALATED", "INTAKE", "DONE", "RETROSPECTIVE"],
    "PLAN_REVIEW": ["MULTI_AGENT_REVIEW", "AWAITING_APPROVAL", "DRAFT_PLAN", "INTERVIEW", "ESCALATED", "INTAKE", "DONE", "RETROSPECTIVE"],
    "AWAITING_APPROVAL": ["APPROVED", "PLAN_REVIEW", "DRAFT_PLAN", "ESCALATED", "INTAKE", "DONE", "RETROSPECTIVE"],
    "APPROVED": ["IN_WORKTREE", "RETROSPECTIVE", "ESCALATED", "INTAKE", "DONE"],
    "IN_WORKTREE": ["WORKTREE_REVIEW", "VERIFY_EXIT", "ROLLED_BACK", "ESCALATED", "INTAKE", "DONE", "RETROSPECTIVE"],
    "WORKTREE_REVIEW": ["MULTI_AGENT_CODE_REVIEW", "VERIFY_EXIT", "IN_WORKTREE", "ROLLED_BACK", "ESCALATED", "INTAKE", "DONE", "RETROSPECTIVE"],
    "MULTI_AGENT_CODE_REVIEW": ["WORKTREE_REVIEW", "VERIFY_EXIT", "IN_WORKTREE", "ROLLED_BACK", "ESCALATED", "INTAKE", "DONE", "RETROSPECTIVE"],
    ...
    "DONE": ["INTAKE", "RETROSPECTIVE"],
    "ROLLED_BACK": ["ESCALATED", "PLAN_REVIEW", "INTAKE", "DONE", "RETROSPECTIVE"],
    "ESCALATED": ["INTAKE", "PLAN_REVIEW", "DONE", "RETROSPECTIVE"]
}
