# os-evolution-verifier — Detailed Reference

Extracted from SKILL.md per Layer-1 procedural-core line budget (issue #551). See SKILL.md
...
## Phase 2 — Dispatch os-architect (commands)
...
## Phase 3 — Artifact Verification (commands)
...
## Phase 5 — Summary Report (format and contract)
...
## Phase 6 — Persist to Experiment Log (command)
