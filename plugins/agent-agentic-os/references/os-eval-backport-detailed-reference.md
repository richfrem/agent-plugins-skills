# os-eval-backport — Detailed Reference
...
## Phase 3 — Structured Assessment (table format and verdicts)
...
## Phase 4: Apply Approved Changes (full steps)
...
## Phase 5: Interrogate the Lab Agent (full question list)
