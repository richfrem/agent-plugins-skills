# os-eval-lab-setup — Detailed Reference
...
## Phase 1: Bootstrap the Lab Repo — full commands

### Set Key Variables First (do this before all other steps)
...
## Phase 2: Generate eval-instructions.md (command)
...
## Phase 3: Confirm Ready — Autonomous execution command
