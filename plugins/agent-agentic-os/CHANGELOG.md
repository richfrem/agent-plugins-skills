...
- ADR-001: replaced direct `run_agent.py` script calls with skill delegation in os-architect-agent.md, os-architect-tester-agent.md, os-evolution-planner, os-evolution-verifier
