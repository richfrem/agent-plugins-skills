...
- [ ] The agent correctly checks the target directory (`docs/architecture/decisions/`) for existing ADRs.
...
- [ ] The agent successfully creates the `docs/architecture/decisions/` directory if it does not already exist during its first run.
