...
> **Architecture Note**: This skill delegates the actual data storage and generation to the `rlm-factory` plugin, but it strongly enforces a pre-configured schema specifically for `tools/` and `plugins/` scripts.
