...
|:--------|:--------------|
| [memory_architecture.mmd](./memory_architecture.mmd) | Full 4-tier memory system with exact plugin/skill/script names per tier |
| [memory_lookup_flow.mmd](./memory_lookup_flow.mmd) | 3-phase search sequence: Hot Cache -> RLM Ledger -> Vector Store -> Grep |
| [memory_session_lifecycle.mmd](./memory_session_lifecycle.mmd) | Session Boot -> Active -> Seal lifecycle with all event types |
