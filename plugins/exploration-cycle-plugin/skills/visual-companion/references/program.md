...
2. `python ./plugins/agent-agentic-os/skills/os-eval-runner/scripts/evaluate.py --skill ./plugins/exploration-cycle-plugin/skills/visual-companion/SKILL.md --desc "what you changed"`
