# Self-Evolution Profile — Obsidian Wiki Engine

## Allowed Edit Directories

- plugins/obsidian-wiki-engine/skills/
- plugins/obsidian-wiki-engine/scripts/
- plugins/obsidian-wiki-engine/references/
...
`plugins/obsidian-wiki-engine/references/evolution-log.md`
