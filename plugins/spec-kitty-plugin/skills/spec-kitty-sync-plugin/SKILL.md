...
|---|---|---|
| `skills/spec-kitty-merge/references/AUGMENTED.md` | Pre-merge safety protocol, branch protection awareness, kitty-specs conflict resolution | New merge flags, changed CLI behavior |
| `skills/spec-kitty-implement/references/AUGMENTED.md` | Worktree discipline, commit hygiene, dependency management | New implement flags, changed validation rules |
| `skills/spec-kitty-review/references/AUGMENTED.md` | Batch review protocol, review standards, dependency verification | New review commands, changed lane logic |
